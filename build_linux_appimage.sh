...
echo "    Build output: dist/Kraken_GUI/"
...
cp -r dist/Kraken_GUI/* "${APPDIR}/usr/bin/"

if [ -f "kraken.png" ]; then
    cp kraken.png "${APPDIR}/${APP_NAME}.png"
else
    echo "    WARNING: kraken.png not found — AppImage will launch without an icon."
fi
