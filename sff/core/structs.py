...
class Settings(Enum):
    ...
    KRAKEN_FAVORITES = SettingItem(
        "kraken_favorites",
        "Favorite App IDs (JSON list, managed automatically)",
        False,
        str,
    )
    KRAKEN_RECENT = SettingItem(
        "kraken_recent",
        "Recently viewed App IDs (JSON list, managed automatically)",
        False,
        str,
    )
    KRAKEN_WHATS_NEW_1_0 = SettingItem(
        "kraken_whats_new_1_0",
        "Kraken 1.0 what's-new shown",
        False,
        bool,
    )
