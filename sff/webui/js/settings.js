...
window.Settings = (function() {
    ...
    var THEMES = [
        { id: 'steam', name: 'Steam', bg: '#1b2838', accent: '#66c0f4' }
    ];
    ...
    function _renderThemePicker() {
        ...
        picker.innerHTML = '';
        var currentTheme = document.documentElement.getAttribute('data-theme') || 'steam';
    ...
    function _initAboutLinks() {
        ...
        if (githubLink) {
            githubLink.addEventListener('click', function(e) {
                e.preventDefault();
                Bridge.call('open_url', 'https://github.com/haker146/Kraken');
            });
        }
            ...
            updateLink.addEventListener('click', function(e) {
                ...
                Bridge.callWithCallback('app_update_check', '', function(json) {
                    ...
                    if (!data.update_available) {
                        resetUpdateButton();
                        Components.showToast('success', 'Kraken is already up to date.');
                        return;
                    }
        ...
        if (clearBtn) {
            clearBtn.addEventListener('click', function() {
                Bridge.callWithCallback('clear_custom_background', function(json) {
                    ...
                    var themeId = document.documentElement.getAttribute('data-theme') || 'steam';
                    _applyTheme(themeId);
    ...
    function _loadCurrentSettings() {
        Bridge.callSync('get_all_settings', function(json) {
            try {
                ...
                // Theme
                if (settings.theme) {
                    var displayedTheme = document.documentElement.getAttribute('data-theme') || 'steam';
