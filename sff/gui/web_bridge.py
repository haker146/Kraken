...
from sff.gui.bridges.store_bridge import (
    _bridge_add_kraken_recent,
    _bridge_connect_store,
    _bridge_get_catalog_status,
    _bridge_get_kraken_favorites,
    _bridge_get_kraken_recent,
    ...
    _bridge_set_kraken_favorite,
    _bridge_set_whats_new_seen,
...
class WebBridge(QObject):
    ...
    def get_catalog_status(self):
        return _bridge_get_catalog_status(self)
    @pyqtSlot(result=str)
    def get_kraken_favorites(self):
        return _bridge_get_kraken_favorites(self)
    @pyqtSlot(str, bool, result=str)
    def set_kraken_favorite(self, app_id, enabled):
        return _bridge_set_kraken_favorite(self, app_id, enabled)
    @pyqtSlot(result=str)
    def get_kraken_recent(self):
        return _bridge_get_kraken_recent(self)
    @pyqtSlot(str, result=str)
    def add_kraken_recent(self, app_id):
        return _bridge_add_kraken_recent(self, app_id)
    @pyqtSlot(result=bool)
    def get_whats_new_seen(self):
        return _bridge_get_whats_new_seen(self)
    @pyqtSlot(result=bool)
    def set_whats_new_seen(self):
        return _bridge_set_whats_new_seen(self)
    @pyqtSlot(str, bool)
    ...
    @pyqtSlot(str, str)
    def activate_dlcs(self, app_id, dlc_ids_json):
        return _bridge_activate_dlcs(self, app_id, dlc_ids_json)
    @pyqtSlot(str, str)
