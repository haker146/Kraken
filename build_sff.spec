...
icon_path = os.path.join(spec_root, 'kraken.ico')
...
if os.path.exists(os.path.join(spec_root, 'kraken.png')):
    datas.append(('kraken.png', '.'))
if os.path.exists(os.path.join(spec_root, 'kraken.ico')):
    datas.append(('kraken.ico', '.'))
